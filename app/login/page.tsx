...
function AtlassianLogo() {
  return (
    ...
    >
      <path
        d="M11.52 0C5.16 0 0 5.16 0 11.52v6.96C0 24.84 5.16 30 11.52 30h6.96C24.84 30 30 24.84 30 18.48V11.52C30 5.16 24.84 0 18.48 0H11.52zM8.4 21.9l4.2-8.4 4.2 8.4H8.4z"
        fill="#0052CC"
      />
      <text
        x="38"
...
function WarningBanner({ message }: { message: React.ReactNode }) {
  return (
    ...
    >
      ...
      <p style={{ fontSize: 14, color: "#172B4D", lineHeight: 1.5, margin: 0 }}>
        {message}
      </p>
    </div>
  );
...
function PrimaryButton({
  ...
  return (
    <button
      ...
      onMouseEnter={(e) => {
        if (!loading) e.currentTarget.style.background = "#0065FF";
      }}
      onMouseLeave={(e) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* half-moon graphic */}
        <path
          d="M216 100 A16 16 0 1 1 216 132"
          stroke="#C0B6F2"
          strokeWidth="4"
          fill="none"
        />
  ...
  return (
    <>
      <Field label="Email">
        ...
        />
        {errors.email && (
          <p style={{ fontSize: 12, color: "#DE350B", marginTop: 4 }}>
            {errors.email}
          </p>
        )}
      </Field>
      ...
      >
        ...
        <span
          ...
          title="Keeps you logged in for 30 days"
        >
          ℹ
        </span>
      </label>

      <PrimaryButton loading={loading} onClick={onContinue}>
        Continue
      </PrimaryButton>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <OutlineButton
          ...
          onClick={() => {}}
        />
        <OutlineButton icon={<AppleIcon />} label="Apple" onClick={() => {}} />
        <OutlineButton icon={<SlackIcon />} label="Slack" onClick={() => {}} />
      </div>
...
function TokenStep({
  ...
  return (
    <>
      ...
      >
        We require additional verification to protect your account. Check your
        email to continue:
      </p>
      <p
        style={{
...
export default function LoginPage() {
        ...
        setErrors({
          general: (
            <>
              ...
              migrated your Trello account to an Atlassian account, you will
              need to use your Atlassian account password. Alternatively, you
              can get help{" "}
              <a href="/forgot-password" style={{ color: "#0052CC" }}>
                logging in
              </a>
              .
            </>
  ...
  const handleTokenVerify = useCallback(async () => {
    ...
    if (code.length < 6) {
      setErrors({ token: "Please enter all 6 digits" });
      return;
    }
    setLoading(true);
    setErrors({});
    try {
      ...
      const error = err as { error?: string; response?: { data?: { error?: string } } };
      setErrors({
        token:
              ...
              <div style={{ textAlign: "center" }}>
                ...
                {step === "email" && (
                  <>
                    ...
                    >
                      <a href="/privacy" style={{ color: "#0052CC" }}>
                        Privacy Policy ↗
                      </a>
                      <span>·</span>
                      <a href="/user-notice" style={{ color: "#0052CC" }}>
                        User Notice ↗
                      </a>
                    </div>
                    <p
