...
function AppleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 814 1000" className="flex-shrink-0" fill="#000">
...
function SlackIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 122.8 122.8" className="flex-shrink-0">
  ...
  return (
    <div className="flex items-center justify-center gap-2">
      ...
      <svg width="16" height="20" viewBox="0 0 32 40" fill="none">
        ...
        />
        <defs>
          <linearGradient id="atl-g1" x1="14.5" y1="4" x2="1" y2="22" gradientUnits="userSpaceOnUse">
            <stop stopColor="#2684FF" />
            <stop offset="1" stopColor="#0052CC" />
          </linearGradient>
          <linearGradient id="atl-g2" x1="17.5" y1="4" x2="23" y2="22" gradientUnits="userSpaceOnUse">
            <stop stopColor="#2684FF" />
            <stop offset="1" stopColor="#0052CC" />
          </linearGradient>
        </defs>
  ...
  return (
    ...
    >
      <svg viewBox="0 0 310 430" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <polyline points="34,145 48,128 62,137 76,118 90,130 100,120" stroke="#5b7fd4" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        {/* content lines */}
        ...
        {/* eye screens */}
        <rect x="53" y="230" width="13" height="10" rx="3" fill="#00e5ff" opacity=".9" />
        <rect x="72" y="230" width="13" height="10" rx="3" fill="#00e5ff" opacity=".9" />
        {/* mouth */}
        ...
        <line x1="69" y1="194" x2="69" y2="191" stroke="#ffd666" strokeWidth="2" strokeLinecap="round" />
        <line x1="59" y1="197" x2="57" y2="195" stroke="#ffd666" strokeWidth="2" strokeLinecap="round" />
        <line x1="79" y1="197" x2="81" y2="195" stroke="#ffd666" strokeWidth="2" strokeLinecap="round" />
        {/* arms */}
        <rect x="14" y="264" width="30" height="13" rx="6.5" fill="#5e4db2" transform="rotate(-10 28 270)" />
        <rect x="93" y="262" width="32" height="13" rx="6.5" fill="#5e4db2" transform="rotate(12 108 268)" />
        {/* item in left hand */}
        ...
        <path d="M168 326 Q198 352 228 326 L228 358 Q198 374 168 358 Z" fill="#2474a8" />
        {/* head */}
        <ellipse cx="198" cy="262" rx="24" ry="26" fill="#f4b49a" />
        {/* hair */}
        <path d="M175 256 Q182 236 198 234 Q214 236 221 256" fill="#8b1a1a" />
        <path d="M221 256 Q228 268 224 280 Q215 258 198 256 Q181 258 172 280 Q168 268 175 256 Z" fill="#8b1a1a" />
        {/* eyes */}
        ...
        {/* smile */}
        <path d="M191 275 Q198 281 205 275" stroke="#c06040" strokeWidth="1.5" fill="none" strokeLinecap="round" />
        {/* arms */}
        <rect x="148" y="294" width="26" height="12" rx="6" fill="#1e5a8a" transform="rotate(-18 160 300)" />
        <rect x="222" y="294" width="26" height="12" rx="6" fill="#1e5a8a" transform="rotate(18 235 300)" />
        {/* pointing hand */}
        ...
        <ellipse cx="8"  cy="368" rx="6" ry="9" fill="#ccc" transform="rotate(-20 8 368)" />
        <ellipse cx="20" cy="366" rx="5" ry="8" fill="#ccc" transform="rotate(15 20 366)" />
        ...
        {/* tail */}
        <path d="M52 386 Q60 376 66 382" stroke="#ccc" strokeWidth="4" fill="none" strokeLinecap="round" />
      </svg>
    </div>
  );
}
    ...
    >
      <svg viewBox="0 0 360 430" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {[0,1,2,3,4,5,6,7].map(i => (
          <rect key={i} x="290" y={128 + i * 28} width="37" height="7" rx="2.5" fill="#96acbc" />
        ))}
        ...
        <path d="M216 212 Q222 224 218 238 Q208 214 194 212 Q180 214 170 238 Q166 224 172 212 Z" fill="#111" />
        {/* glasses */}
        <rect x="181" y="214" width="12" height="9" rx="3" fill="none" stroke="#333" strokeWidth="1.5" />
        <rect x="199" y="214" width="12" height="9" rx="3" fill="none" stroke="#333" strokeWidth="1.5" />
        <line x1="193" y1="218.5" x2="199" y2="218.5" stroke="#333" strokeWidth="1.5" />
        {/* smile */}
        <path d="M187 230 Q194 236 201 230" stroke="#c07050" strokeWidth="1.5" fill="none" strokeLinecap="round" />
        {/* arms */}
        <rect x="144" y="244" width="26" height="12" rx="6" fill="#1a2b3c" transform="rotate(-15 156 250)" />
        <rect x="218" y="244" width="26" height="12" rx="6" fill="#1a2b3c" transform="rotate(15 230 250)" />
        ...
        {/* belly */}
        <ellipse cx="316" cy="308" rx="20" ry="26" fill="#ffb89a" opacity=".7" />
        {/* head */}
        ...
        {/* big smile */}
        <path d="M302 256 Q316 268 330 256" stroke="#c05a30" strokeWidth="2.5" fill="#ff7043" strokeLinecap="round" />
        {/* arms */}
        <path d="M280 280 Q262 274 256 288" stroke="#ff9f7f" strokeWidth="16" strokeLinecap="round" fill="none" />
        <path d="M352 280 Q370 280 374 268" stroke="#ff9f7f" strokeWidth="16" strokeLinecap="round" fill="none" />
        {/* legs */}
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Failed to start registration. Please try again.');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        <div
          style={{
            ...
            boxShadow: '0 4px 16px rgba(9,30,66,0.10), 0 0 1px rgba(9,30,66,0.08)',
            overflow: 'hidden',
          }}
        >
          {/* ────────── Main form section ────────── */}
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                ...
                <a
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.color = '#0065ff'; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.color = '#0052cc'; }}
                >
              ...
              <button
                ...
                onMouseEnter={e => { if (!loading) (e.currentTarget as HTMLButtonElement).style.background = '#0065ff'; }}
