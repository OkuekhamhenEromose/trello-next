...
export default function SetupAccountPage() {
  ...
  useEffect(() => {
    // Get email and token from URL params or session storage
    ...
    if (emailParam && tokenParam) {
      ...
      if (storedEmail && storedToken && emailVerified) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("🔍 Completing registration for:", {
        email,
        fullName,
      ...
      const finalUsername =
        usernameFromEmail && usernameFromEmail.trim() !== ""
          ? usernameFromEmail
          : `user_${Date.now()}`;
  ...
  return (
    <div className="min-h-screen bg-[hsl(220,20%,97%)] flex flex-col items-center justify-center relative overflow-hidden">
      {/* Left decorative illustration (same as before) */}
      <div className="hidden lg:block absolute left-0 bottom-0 w-[320px] h-[420px]">
        <svg viewBox="0 0 320 420" fill="none" className="w-full h-full">
          ...
          />
          <polyline
            points="30,168 46,158 62,162 78,148"
      ...
      <div className="hidden lg:block absolute right-0 bottom-0 w-[320px] h-[420px]">
        <svg viewBox="0 0 320 420" fill="none" className="w-full h-full">
          ...
          <line
            ...
            x2="100"
            y2="192"
            stroke="hsl(350,55%,72%)"
            strokeWidth="3"
          />
          <circle cx="100" cy="189" r="5" fill="hsl(45,85%,65%)" />
          <path
            d="M60 260 Q40 270 35 290"
            stroke="hsl(350,55%,72%)"
            strokeWidth="10"
            strokeLinecap="round"
            fill="none"
      ...
      <div className="w-full max-w-[400px] mx-4 bg-white rounded-lg shadow-[0_4px_24px_rgba(0,0,0,0.12)] z-10">
        <div className="px-10 pt-10 pb-6">
          ...
          <div className="flex items-center justify-center gap-2.5 mb-7">
            ...
            <span className="text-[28px] font-bold text-[hsl(213,30%,22%)] tracking-tight">
              Trello
            </span>
          </div>
          ...
          <div className="text-center mb-6">
            <div className="flex items-center justify-center gap-1.5 mb-1">
              <span className="text-[15px] font-bold text-[hsl(213,30%,20%)]">
                Email address verified
              </span>
              <CheckCircle2 className="w-5 h-5 text-green-500 fill-green-500 stroke-white" />
            </div>
            <p className="text-sm text-[hsl(213,20%,42%)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-[hsl(213,30%,20%)] mt-0.5">
                {email}
              </p>
            </div>
            ...
            <div>
              ...
              <div className="mt-2">
                ...
                {password ? (
                  <p
                    className={`text-xs text-center mt-1.5 font-medium ${getPasswordLabelColor()}`}
                  >
                    {getPasswordLabel()}
                  </p>
                ) : (
